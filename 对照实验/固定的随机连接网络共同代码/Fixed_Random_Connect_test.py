...
# model.load_state_dict(torch.load('./Fixed_Random_Connect_3/Fixed_Random_Connect_15.pkl'))
# model.load_state_dict(torch.load('./Fixed_Random_Connect_4/Fixed_Random_Connect_15.pkl'))
model.load_state_dict(torch.load('./Fixed_Random_Connect_5/Fixed_Random_Connect_15.pkl'))
...
#Test Loss:0.475113,Accuracy:0.837300