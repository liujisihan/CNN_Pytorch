...
class DenseNet(nn.Module):
    ...
    def __init__(self, growth_rate=32, block_config=(6, 12, 24, 16),
        ...
        #为了对照，后面加上全连接层
        self.features.add_module('normal_conv1',Normal_Conv(num_input_features=num_features,factor=1))
        self.features.add_module('normal_conv2',Normal_Conv(num_input_features=num_features,factor=2))
        # Linear layer
