...
# file=open('./Fixed_Random_Connect_2/Fixed_Random_Connect.csv','a')
# file=open('./Fixed_Random_Connect_3/Fixed_Random_Connect.csv','a')
# file=open('./Fixed_Random_Connect_4/Fixed_Random_Connect.csv','a')
file=open('./Fixed_Random_Connect_5/Fixed_Random_Connect.csv','a')
...
for epoch in range(num_epoches):
    ...
    if(epoch+1)%5==0:
        # 每10个epoch保存一个模型
        torch.save(model.state_dict(), './Fixed_Random_Connect_5/Fixed_Random_Connect_{}.pkl'.format(epoch+1))
writer.writerow(loss_data)
file.close()
